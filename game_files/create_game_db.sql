...
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (1, 'Reward for returning a lost passport!', 0, '150,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (2, 'Lost bet on a street performer.', 0, '-150,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (3, 'Returned a lost wallet, earned gratitude and euros!', 0, '50,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (4, 'Lost money in a scam.', 0, '-200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (5, 'Sold collectibles for cash.', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (6, 'You found hidden euros under a park bench!', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (7, 'Won a trivia contest.', 0, '125,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (8, 'Donate to local museum.', 0, '-200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (9, 'Roll for lottery ticket prize.', 7, '700,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (10, 'Lost money on a train ticket.', 0, '-75,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (11, 'Invest in a promising startup. Roll for outcome.', 6, '400,0', '-200,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (12, 'Roll to win for hostile poker game.', 7, '500,0', '-150,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (13, 'You dine at hamburger place.', 0, '-50,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (14, 'Oh noh, you were robbed from all of your PP!', 0, 'robbed,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (15, 'Donated to a charity fundraiser.', 0, '-100,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (16, 'A talking parrot stole your wallet! Roll to get it back', 6, '0,0', '-100,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (17, 'Found PP inside a fortune cookie.', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (18, 'Won a burping contest prize.', 0, '300,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (19, 'Paid for a guided tour by a robot vacuum cleaner.', 0, '-50,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (20, 'Compete in a banana-peeling contest. Roll outcome', 7, '400,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (21, 'Helped a friendly alien with luggage.', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (22, 'Invested in a Ninja Sock startup. Roll outcome', 6, '600,0', '-200,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (23, 'Sold an air guitar for cash.', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (24, 'Earn PP as a human statue. Locked in for one round.', 0, '200,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (25, 'Locked in a sausage museum overnight for one round.', 0, '0,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (26, 'Paid for a leatherpant fashion show.', 0, '-45,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (27, 'You are arm-wrestling a sumo wrestler. Roll for outcome.', 10, '900,0', '-50,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (28, 'Bought a leprechauns pot of PP.', 0, '400,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (29, 'Lost money on a sausage sculpture challenge. Roll outcome.', 6, '-50,0', '-250,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (30, 'Locked in a beer-themed escape room. Roll outcome.', 6, '0,1', '0,2', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (31, 'Police caught you scamming cryptocurrency from old people. You go to jail for 4 turns and lose all your PP.', 0, 'robbed,4', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (32, 'Locked in a restroom with broken lock. Roll outcome.', 6, '0,1', '0,2', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (33, 'Trapped in an elevator with a quirky AI. Locked for one round.', 0, '0,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (34, 'Invested in a Get-Rich-Quick scheme.', 0, '-125,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (35, 'Mistook PP for Monopoly money.', 0, '-50,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (36, 'Won euros arm-wrestling a robot.', 0, '300,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (37, 'Invested in a cryptocurrency bubble.', 0, '500,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (38, 'Invested in a business selling bottled air. Roll for outcome.', 5, '400,0', '-200,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (39, 'Paid for a psychics advice on winning the lottery. Roll for outcome.', 6, '600,0', '-100,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (40, 'Trapped in an elevator playing elevator music. Locked for one round.', 0, '0,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (41, 'Earned PP by performing magic tricks on the street.', 0, '300,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (42, 'Received a reward for honesty. Locked for one round.', 0, '0,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (43, 'Won a chess match against a local expert.', 0, '250,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (44, 'Won a poker game with the locals.', 0, '150,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (45, 'Received a reward for returning a lost wallet.', 0, '100,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (46, 'Won a treasure hunt competition.', 0, '300,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (47, 'Helped a lost dog find its owner. Locked for one round', 0, '150,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (48, 'Won a limbo dance contest.', 0, '200,0', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (49, 'Found a hidden diary with intriguing stories. Locked for one round.', 0, '0,1', '0,0', null);
INSERT INTO kadonnut_testamentti.random_events (id, fluff, roll_treshold, outcome_higher, outcome_lower, location) VALUES (50, 'Found a hidden cave with glittering gemstones. Roll for outcome.', 7, '1200,0', '600,0', null);
